...
class VideoCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video_comment" do
    assert_difference('VideoComment.count') do
      post video_comments_url, params: { video_comment: { comment: @video_comment.comment, user_id: @video_comment.user_id, video_id: @video_comment.video_id } }
    end
  ...
  test "should update video_comment" do
    patch video_comment_url(@video_comment), params: { video_comment: { comment: @video_comment.comment, user_id: @video_comment.user_id, video_id: @video_comment.video_id } }
