...
class UserLikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_like" do
    assert_difference('UserLike.count') do
      post user_likes_url, params: { user_like: { user_id: @user_like.user_id, video_id: @user_like.video_id } }
    end
  ...
  test "should update user_like" do
    patch user_like_url(@user_like), params: { user_like: { user_id: @user_like.user_id, video_id: @user_like.video_id } }
